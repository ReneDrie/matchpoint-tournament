    ...
    >
      ...
      >
        <div className="modal-header">
          <div>
            <p>SPONSORPAKKET</p>
            <h2 id="package-modal-title">{sponsorPackage ? "Pakket wijzigen" : "Pakket toevoegen"}</h2>
          </div>
        ...
        <div className="modal-grid">
          <label className="modal-wide">
            ...
            <input
              ...
              placeholder="Bijvoorbeeld Hoofdsponsor"
            />
          </label>
          <label>
            Eenmalige kosten
            ...
            <small>Wordt later als factuurbedrag gebruikt.</small>
          </label>
          <label>
            Standaard extra spelers
            <input
              type="number"
              min="0"
              max="256"
              required
              value={form.includedPlayers}
              onChange={(event) => form.setIncludedPlayers(Number(event.target.value))}
            />
            <small>Per sponsor afzonderlijk te overriden.</small>
          </label>
        </div>
        ...
        <div className="modal-actions">
          {sponsorPackage && (
            <button
              ...
              onClick={form.remove}
              disabled={form.busy || sponsorPackage.sponsor_count > 0}
            >
              Verwijderen
            </button>
          )}
          ...
          >
            {form.busy ? "Opslaan…" : "Pakket opslaan"}
          </button>
        </div>
      </form>
    </div>

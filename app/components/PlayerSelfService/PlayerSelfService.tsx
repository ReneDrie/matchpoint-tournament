        ...
        {!token ? (
          service.linkSent ? (
            <>
              ...
              <p className="muted">
                Als dit e-mailadres bij een actieve inschrijving hoort, ontvang je een persoonlijke link. Deze is 30
                minuten geldig.
              </p>
            </>
          ) : (
            <form onSubmit={service.requestLink}>
              ...
              <p className="muted">
                Je ontvangt een eenmalige, persoonlijke link op het e-mailadres van je inschrijving.
              </p>
              <label>
                E-mailadres
                <input
          ...
          <>
            ...
            <p className="muted">
              Deze persoonlijke link is nu gebruikt. Vraag een nieuwe link aan als je later opnieuw iets wilt wijzigen.
            </p>
          ...
          <form onSubmit={service.save}>
            ...
            <div className="player-self-service-fields">
              <label>
                ...
                <input
                  required
                  value={service.form.name}
                  onChange={(event) => service.update("name", event.target.value)}
                />
              </label>
              <label>
                E-mailadres
              ...
              <label>
                ...
                <input
                  required
                  type="tel"
                  value={service.form.phone}
                  onChange={(event) => service.update("phone", event.target.value)}
                />
              </label>
              <label>
                Geboortedatum
                <input
                  required
                  type="date"
                  value={service.form.date_of_birth}
                  onChange={(event) => service.update("date_of_birth", event.target.value)}
                />
              </label>
              <label>
                KNLTB bondsnummer
                <input
                  value={service.form.knltb_number}
                  onChange={(event) => service.update("knltb_number", event.target.value)}
                />
              </label>
              <label>
                Speelsterkte enkel
                <input
                  value={service.form.singles_rating}
                  onChange={(event) => service.update("singles_rating", event.target.value)}
                />
              </label>
              <label>
                Speelsterkte dubbel
                <input
                  value={service.form.doubles_rating}
                  onChange={(event) => service.update("doubles_rating", event.target.value)}
                />
              </label>
              <label>
                Opkomstnummer
                <input
                  required
                  value={service.form.entrance_song_query}
                  onChange={(event) => service.update("entrance_song_query", event.target.value)}
                />
              </label>
            </div>

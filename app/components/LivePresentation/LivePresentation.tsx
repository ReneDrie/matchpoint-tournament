...
export function LivePresentation() {
  ...
  if (presentation.loading && !presentation.data)
    return (
      <main className="live-presentation loading">
        <div>
          <strong>Matchpoint Tournament</strong>
          <span>Live presentatie laden…</span>
        </div>
      </main>
    );
  return (
    <main className="live-presentation" onClick={presentation.next}>
